...
namespace PosApp.Admin.Api.Controllers.Admin
{
    ...
    public class EmailTemplateController : AdminBaseController<EmailTemplate>
    {
        public EmailTemplateController(IServiceProvider serviceProvider) : base(serviceProvider)
        {
            ...
            try
            {
                var result = await Repository.Queryable().AsNoTracking()
                    .Select(c => new
                    {
                        ...
                        c.CreatedDate,
                        c.UpdatedDate,
                        SmtpAccount = c.SmtpAccount.UserName,
